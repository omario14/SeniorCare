...
export default function Body() {
  ...
  const openPopover = (event, bodyPart) => {
  ...
  const fetchData = async () => {
    ...
    return symptomsService.findByBodyPart(getStepContent(bodyPart))
      .then(result => {
      ...
      <>
        ...
        >
          <div className='popoverbody' >
            <Typography className='titlepopover' variant='h5' style={{ fontWeight: 600, letterSpacing: "0.11562em" }} >{bodyPart}</Typography>
            <CloseIcon className='closebUtton' onClick={() => setAnchor(null)} />
          ...
          <div className='popoverFooter'>
            <Alert severity="info">
              ...
              Can't find a symptom? Please try to use <strong>the search box!</strong>
            </Alert>
    ...
    <div >
      ...
      <div className="human-body" >
        ...
        <div className='ARM'>
          ...
          <svg data-position='right-shoulder' id='right-shoulder' className='right-shoulder' xmlns='http://www.w3.org/2000/svg' width='109.532' height='46.594' viewBox='0 0 109.532 46.594'>
            <path onClick={(e) => {
              openPopover(e, "ARM");
          ...
          <svg data-position='left-arm' id='left-arm' className='left-arm' xmlns='http://www.w3.org/2000/svg' width='156.344' height='119.25' viewBox='0 0 156.344 119.25'>
            <path onClick={(e) => {
              openPopover(e, "ARM");
          ...
          <svg data-position='right-arm' id='right-arm' className='right-arm' xmlns='http://www.w3.org/2000/svg' width='156.344' height='119.25' viewBox='0 0 156.344 119.25'>
            <path onClick={(e) => {
              openPopover(e, "ARM");
          ...
          <svg data-position='left-hand' id='left-hand' className='left-hand' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
            <path onClick={(e) => {
              openPopover(e, "ARM");
            }} d='m 21.255,-0.00198191 2.88,6.90000201 8.412,1.335 0.664,12.4579799 -4.427,17.8 -2.878,-0.22 2.8,-11.847 -2.99,-0.084 -4.676,12.6 -3.544,-0.446 4.4,-12.736 -3.072,-0.584 -5.978,13.543 -4.428,-0.445 6.088,-14.1 -2.1,-1.25 L 4.878,34.934 1.114,34.489 12.4,12.9 11.293,11.12 0.665,15.57 0,13.124 8.635,5.3380201 Z' /></svg>
          <svg data-position='right-hand' id='right-hand' className='right-hand' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
            <path onClick={(e) => {
              openPopover(e, "ARM");
        ...
        <div className='CHEST'>
          <svg data-position='chest' id='chest' className='chest' xmlns='http://www.w3.org/2000/svg' width='86.594' height='45.063' viewBox='0 0 86.594 45.063'>
            <path onClick={(e) => {
              openPopover(e, "CHEST");
            }} d='M19.32 0l-9.225 16.488-10.1 5.056 6.15 4.836 4.832 14.07 11.2 4.616 17.85-8.828-4.452-34.7zm47.934 0l9.225 16.488 10.1 5.056-6.15 4.836-4.833 14.07-11.2 4.616-17.844-8.828 4.45-34.7z' /></svg>
        </div>
        <div className='ABDOMEN'>
          <svg data-position='stomach' id='stomach' className='stomach' xmlns='http://www.w3.org/2000/svg' width='75.25' height='107.594' viewBox='0 0 75.25 107.594'>
            <path onClick={(e) => {
              openPopover(e, "ABDOMEN");
        ...
        <div className='LEGS'>
          <svg data-position='left-leg' id='left-leg' className='left-leg' xmlns='http://www.w3.org/2000/svg' width='93.626' height='250.625' viewBox='0 0 93.626 250.625'>
            <path onClick={(e) => {
              openPopover(e, "LEGS");
          ...
          <svg data-position='right-leg' id='right-leg' className='right-leg' xmlns='http://www.w3.org/2000/svg' width='80' height='250.625' viewBox='0 0 80 250.625'>
            <path onClick={(e) => {
              openPopover(e, "LEGS");
          ...
          <svg data-position='left-foot' id='left-foot' className='left-foot' xmlns='http://www.w3.org/2000/svg' width='30' height='30' viewBox='0 0 30 30'>
            <path onClick={(e) => {
              openPopover(e, "LEGS");
          ...
          <svg data-position='right-foot' id='right-foot' className='right-foot' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
            <path onClick={(e) => {
              openPopover(e, "LEGS");
            }} d='m 11.723492,2.35897 c -40.202667,20.558 -20.1013335,10.279 0,0 z m -5.9740005,5.989 0.663,18.415 1.546,6.435 4.6480005,0 1.328,-4.437 1.55,-0.222 -0.333,4.437 5.863,-1.778 1.55,-0.887 6.638,-1.442 0.222,-5.214 -6.418,-10.868 -4.426,-5.547 -10.8440005,-4.437 z' /> </svg>
